...
public class FollowServiceImpl extends ServiceImpl<FollowMapper, Follow> implements IFollowService {
    ...
    public Result followCommons(Long id) {
        Long userId = UserHolder.getUser().getId();
        String k1 = "follows:" + userId, k2 = "follows:" + id;
        ...
        List<UserDTO> users = userService.listByIds(followCommonIds).stream().map(user -> BeanUtil.copyProperties(user, UserDTO.class)).collect(Collectors.toList());
